  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="p-6 rounded-xl border border-[#d6d6d6] bg-white space-y-4">
        <h2 className="text-lg font-medium text-black border-b border-[#d6d6d6] pb-2">Admin Credentials</h2>
        <p className="text-sm text-[#888]">
          Your admin password is managed via the <code className="bg-[#eeeeee] px-2 py-0.5 rounded text-black text-xs">ADMIN_PASSWORD</code> environment variable in your <code className="bg-[#eeeeee] px-2 py-0.5 rounded text-black text-xs">.env</code> file. Restart the server after changing it.
        </p>
        <div className="flex items-center gap-3 p-4 bg-[#f6f6f6] rounded-lg border border-[#c7c7c7]">
          <code className="text-sm text-[#888] flex-1 font-mono">
            ADMIN_PASSWORD={showPassword ? "your_password_here" : "••••••••••••"}
          </code>
          <button onClick={() => setShowPassword(s => !s)} className="text-[#666] hover:text-black transition-colors">
      ...
      <div className="p-6 rounded-xl border border-[#d6d6d6] bg-white space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="p-4 bg-[#f6f6f6] rounded-lg border border-[#c7c7c7]">
            ...
            <div className="text-black font-medium font-mono text-sm">prisma/dev.db</div>
          </div>
        </div>
      </div>
